...
public class ImageProcessor {
	...
	public static Mat extend(Mat img, Size newSize, int x, int y) {
		...
		Imgproc.warpAffine(img, result, matrix, newSize, Imgproc.INTER_LINEAR, Core.BORDER_TRANSPARENT,
				new Scalar(0, 0, 0, 0));
		return result;
	}
	...
	public static void addStars(Mat src, Mat dst, Mat shape, int count) {
		...
		for (int i = 0; i < count; i++) {
			...
			Imgproc.warpAffine(star, starImage, matrix, src.size(), Imgproc.INTER_LINEAR, Core.BORDER_TRANSPARENT,
					new Scalar(0, 0, 0, 0));
	...
	public static void addSnow(Mat src, Mat dst, int count) {
		...
		for (int i = 0; i < count; i++) {
			...
			Imgproc.warpAffine(bubble, bubbleImage, matrix, src.size(), Imgproc.INTER_LINEAR, Core.BORDER_TRANSPARENT,
					new Scalar(0, 0, 0, 0));
